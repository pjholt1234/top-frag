...
class DemoParserEventRequest extends FormRequest
{
    ...
    private function getGrenadeEventRules(): array
    {
        return [
            ...
            'data.*.friendly_flash_duration' => 'nullable|numeric|min:0|max:10',
            'data.*.enemy_flash_duration' => 'nullable|numeric|min:0|max:10',
            'data.*.friendly_players_affected' => 'nullable|integer|min:0|max:10',
            'data.*.enemy_players_affected' => 'nullable|integer|min:0|max:10',
