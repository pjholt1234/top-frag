...
type SortField = 'map' | 'matches' | 'wins' | 'win_rate' | 'avg_kills' | 'avg_assists' |
    'avg_deaths' | 'avg_kd' | 'avg_adr' | 'avg_opening_kills' | 'avg_opening_deaths' |
    'fragger' | 'support' | 'opener' | 'closer';
    ...
    const sortedMaps = useMemo(() => {
        ...
        if (sortField && sortDirection) {
            sorted = sorted.sort((a, b) => {
                ...
                } else if (['fragger', 'support', 'opener', 'closer'].includes(sortField)) {
