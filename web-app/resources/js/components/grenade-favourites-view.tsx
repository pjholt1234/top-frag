...
import { useGrenadeFavouritesLibrary, GrenadeFavouritesLibraryProvider, FavouritedGrenadeData } from '../hooks/useGrenadeFavouritesLibrary';
import { GrenadeData } from '../hooks/useGrenadeLibrary';

interface GrenadeFavouritesViewProps {
...
const GrenadeFavouritesViewContent: React.FC<GrenadeFavouritesViewProps> = ({
    ...
    const handleListGrenadeClick = (grenade: FavouritedGrenadeData | GrenadeData) => {
            ...
            <div className="flex gap-6 items-start justify-center">
                ...
                {isLoading ? (
                    ...
                    <GrenadeList
                        ...
                        selectedGrenadeId={selectedGrenadeId}
                        showFavourites={false} // Don't show favourite buttons since these are already favourited
                        useFavouritesContext={true}
...
const GrenadeFavouritesView: React.FC<GrenadeFavouritesViewProps> = (props) => {
    return (
        <GrenadeFavouritesLibraryProvider initialFilters={props.initialFilters}>
            <GrenadeFavouritesViewContent {...props} />
        </GrenadeFavouritesLibraryProvider>
    );
};

export default GrenadeFavouritesView;
