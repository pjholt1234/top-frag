                        ...
                        {grenadePositions.map((position, index) => {
                            ...
                            return (
                                <React.Fragment key={index}>
                                    ...
                                    {isSelected && position.player_x !== undefined && position.player_y !== undefined && (
                                        <>
                                            <Line
                                                points={[
                                                    pixelCoords.x,
                                                    pixelCoords.y,
                                                    convertGameToPixelCoords(position.player_x, position.player_y).x,
                                                    convertGameToPixelCoords(position.player_x, position.player_y).y
                                                ]}
                                            ...
                                            <Line
                                                points={[
                                                    convertGameToPixelCoords(position.player_x, position.player_y).x - 6,
                                                    convertGameToPixelCoords(position.player_x, position.player_y).y - 6,
                                                    convertGameToPixelCoords(position.player_x, position.player_y).x + 6,
                                                    convertGameToPixelCoords(position.player_x, position.player_y).y + 6
                                                ]}
