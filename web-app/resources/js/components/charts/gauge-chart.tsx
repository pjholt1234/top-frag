...
export function GaugeChart({
    ...
    // Size configurations
    const sizeConfig = {
        sm: { fontSize: 'text-sm', textSize: 'text-xs', containerClass: 'w-30 h-20' },
        md: { fontSize: 'text-base', textSize: 'text-sm', containerClass: 'w-40 h-25' },
        lg: { fontSize: 'text-lg', textSize: 'text-base', containerClass: 'w-80 h-50' },
    };
