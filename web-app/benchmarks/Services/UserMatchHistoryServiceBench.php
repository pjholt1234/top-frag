...
class MatchHistoryServiceBench implements BenchmarkInterface
{
     ...
     * @Assert("mode(variant.time.avg) < 50ms")
     */
    public function benchGetAllPlayerGunfightEvents(): void
    {
        $this->service->getAllPlayerGunfightEvents($this->match, $this->player);
    }
     ...
     */
    public function benchCalculateKillDeathRatio(): void
    {
        // Test with various kill/death ratios
        $this->service->getAllPlayerGunfightEvents($this->match, $this->player);
    }
